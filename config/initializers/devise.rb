...
Devise.setup do |config|
  ...
  config.secret_key = '3709bd21de3fad0302e4be667771a7c8776cebb1cf43c6b5d024073e8fcae99b5abcadc566a1780f114e9aff3e2d2e53f1b98d217a8ac3dc907099b3e2f64328'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'rashmi.krishnan@sv.cmu.edu'
  ...
  # config.pepper = '902a3bdfc9aa0ecc8c2b822542ce2c96697b373f3b227b409d8118248ceacaf3274d7b5122c60ff350564072d109d89abc04c9bdee3341c3c1e8f6bf8803fdf0'
  ...
  config.email_regexp = /[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.+-]+\.edu/
